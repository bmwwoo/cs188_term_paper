...
% TODO Talk about how max user count limited our tests in time
% TODO Show graph that illustrates the user arrival rate
% TODO Talk about using small subset of stocks to ensure cache hits
