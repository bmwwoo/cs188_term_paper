...
\end{figure}
  ...
  We did our Memcached testing on a single \texttt{m3.Large} instance.  As shown in Figure \ref{graph:memcached}, Memcached let us serve more users per second, on average.  Figure \ref{graph:memcached_latency} shows the latency per request over the time of the tests.\\
